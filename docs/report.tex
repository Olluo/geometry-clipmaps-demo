...
% Introduce the topic
% Why is this focus area interesting? Examples mando
% What will I discuss
% What are key questions and challenges
% Why it is important that I reviewed literature in this area

% talk about how the project will start off with fake 3D with only height data and no options for overhangs due to xz coords being uniform
...
% What the paper has been about.

% What existing solutions.

% What I am taking forward to my project.

% What issues there might be.

% How the project will be graded as successful or not.
